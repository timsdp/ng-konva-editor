...
export class PropertiesComponent implements OnInit {
  ...
  >([
    ...
    [
      PropertyName.Left,
      (element: ContentElement) => {
        return Math.round(element.X).toString();
      },
    ],
    [
      PropertyName.Top,
      (element: ContentElement) => {
        return Math.round(element.Y).toString();
      },
    ],
  ]);
  ...
  ngOnInit(): void {
    ...
    this.Properties.push(
      new Property(PropertyType.Text, PropertyName.Name, true)
    );
    this.Properties.push(
      new Property(PropertyType.Text, PropertyName.ElementType, true)
    );
  }
