...
(function (f) {
    ...
    var _$isWindow_75 = {};
    "use strict";
    Object.defineProperty(_$isWindow_75, "__esModule", {
        value: true
    });
    _$isWindow_75["default"] = void 0;
    var _default = function _default(thing) {
        return !!(thing && thing.Window) && thing instanceof thing.Window;
    };
    _$isWindow_75["default"] = _default;
    var _$window_82 = {};
    "use strict";
    Object.defineProperty(_$window_82, "__esModule", {
        value: true
    });
    _$window_82.init = init;
    _$window_82.getWindow = getWindow;
    _$window_82.window = _$window_82.realWindow = void 0;
    /* removed: var _$isWindow_75 = require("./isWindow.js"); */
    ;
    var realWindow = undefined;
    _$window_82.realWindow = realWindow;
    var win = undefined;
    _$window_82.window = win;
    function init(window) {
        // get wrapped window if using Shadow DOM polyfill
        _$window_82.realWindow = realWindow = window; // create a TextNode
        var el = window.document.createTextNode(''); // check if it's wrapped by a polyfill
        if (el.ownerDocument !== window.document && typeof window.wrap === 'function' && window.wrap(el) === el) {
            // use wrapped window
            window = window.wrap(window);
        }
        _$window_82.window = win = window;
    }
    if (typeof window !== 'undefined' && !!window) {
        init(window);
    }
    function getWindow(node) {
        if ((0, _$isWindow_75["default"])(node)) {
            return node;
        }
    ...
    var _$is_74 = {};
    "use strict";
    Object.defineProperty(_$is_74, "__esModule", {
        value: true
    });
    _$is_74["default"] = void 0;
    /* removed: var _$isWindow_75 = require("./isWindow.js"); */
    ;
    /* removed: var _$window_82 = require("./window.js"); */
    ;
    var __window_74 = function window(thing) {
        return thing === _$window_82.window || (0, _$isWindow_75["default"])(thing);
    };
    ...
    var element = function element(thing) {
        ...
        var _window = _$window_82.getWindow(thing) || _$window_82.window;
    ...
    /* removed: var _$is_74 = require("../../utils/is.js"); */
    ;
    function install(scope) {
        var actions = scope.actions, Interactable = scope.Interactable, defaults = scope.defaults;
    ...
    var draggable = function draggable(options) {
        if (_$is_74["default"].object(options)) {
        ...
        if (_$is_74["default"].bool(options)) {
    ...
    var drag = {
        ...
        listeners: {
            ...
            'auto-start:check': function autoStartCheck(arg) {
                var interaction = arg.interaction, interactable = arg.interactable, buttons = arg.buttons;
    ...
    /* removed: var _$domObjects_69 = require("./domObjects.js"); */
    ;
    /* removed: var _$is_74 = require("./is.js"); */
    ;
    /* removed: var _$window_82 = require("./window.js"); */
    ;
    var browser = {
    ...
    function __init_67(window) {
        var Element = _$domObjects_69["default"].Element;
        var navigator = _$window_82.window.navigator; // Does the browser support touch input?
        browser.supportsTouch = 'ontouchstart' in window || _$is_74["default"].func(window.DocumentTouch) && _$domObjects_69["default"].document instanceof window.DocumentTouch; // Does the browser support PointerEvents
        browser.supportsPointerEvent = navigator.pointerEnabled !== false && !!_$domObjects_69["default"].PointerEvent;
        ...
        browser.pEventTypes = browser.supportsPointerEvent ? _$domObjects_69["default"].PointerEvent === window.MSPointerEvent ? {
            up: 'MSPointerUp',
            down: 'MSPointerDown',
            over: 'mouseover',
            out: 'mouseout',
        ...
        browser.wheelEvent = 'onmousewheel' in _$domObjects_69["default"].document ? 'mousewheel' : 'wheel';
    }
    ...
    function parentNode(node) {
        ...
        if (_$is_74["default"].docFrag(parent)) {
            // skip past #shado-root fragments
            // tslint:disable-next-line
            while ((parent = parent.host) && _$is_74["default"].docFrag(parent)) {
                continue;
            }
            return parent;
        }
    ...
    function matchesSelector(element, selector) {
        ...
        if (_$window_82.window !== _$window_82.realWindow) {
    ...
    function indexOfDeepestElement(elements) {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            if (deepestNode instanceof _$domObjects_69["default"].HTMLElement && currentNode instanceof _$domObjects_69["default"].SVGElement && !(currentNode instanceof _$domObjects_69["default"].SVGSVGElement)) {
    ...
    function zIndexIsHigherThan(higherNode, lowerNode) {
        var higherIndex = parseInt(_$window_82.getWindow(higherNode).getComputedStyle(higherNode).zIndex, 10) || 0;
        var lowerIndex = parseInt(_$window_82.getWindow(lowerNode).getComputedStyle(lowerNode).zIndex, 10) || 0;
    ...
    function getScrollXY(relevantWindow) {
        relevantWindow = relevantWindow || _$window_82.window;
        return {
    ...
    function getElementClientRect(element) {
        var clientRect = element instanceof _$domObjects_69["default"].SVGElement ? element.getBoundingClientRect() : element.getClientRects()[0];
        return clientRect && {
    ...
    function getElementRect(element) {
        ...
        if (!_$browser_67["default"].isIOS7 && clientRect) {
            var scroll = getScrollXY(_$window_82.getWindow(element));
    ...
    function trySelector(value) {
        if (!_$is_74["default"].string(value)) {
            return false;
        } // an exception will be raised if it is invalid
        _$domObjects_69["default"].document.querySelector(value);
        return true;
    }
    var _$extend_71 = {};
    "use strict";
    Object.defineProperty(_$extend_71, "__esModule", {
        value: true
    });
    _$extend_71["default"] = extend;
    ...
    var _$rect_81 = {};
    "use strict";
    Object.defineProperty(_$rect_81, "__esModule", {
        value: true
    });
    _$rect_81.getStringOptionResult = getStringOptionResult;
    _$rect_81.resolveRectLike = resolveRectLike;
    _$rect_81.rectToXY = rectToXY;
    _$rect_81.xywhToTlbr = xywhToTlbr;
    _$rect_81.tlbrToXywh = tlbrToXywh;
    _$rect_81.addEdges = addEdges;
    /* removed: var _$domUtils_70 = require("./domUtils.js"); */
    ;
    /* removed: var _$extend_71 = require("./extend.js"); */
    ;
    /* removed: var _$is_74 = require("./is.js"); */
    ;
    ...
    function resolveRectLike(value, target, element, functionArgs) {
        ...
        if (_$is_74["default"].string(returnValue)) {
            returnValue = getStringOptionResult(returnValue, target, element);
        }
        else if (_$is_74["default"].func(returnValue)) {
            returnValue = returnValue.apply(void 0, functionArgs);
        }
        if (_$is_74["default"].element(returnValue)) {
    ...
    function xywhToTlbr(rect) {
        if (rect && !('left' in rect && 'top' in rect)) {
            rect = (0, _$extend_71["default"])({}, rect);
            rect.left = rect.x || 0;
            rect.top = rect.y || 0;
    ...
    var _$getOriginXY_72 = {};
    "use strict";
    Object.defineProperty(_$getOriginXY_72, "__esModule", {
        value: true
    });
    _$getOriginXY_72["default"] = ___default_72;
    /* removed: var _$rect_81 = require("./rect.js"); */
    ;
    function ___default_72(target, element, actionName) {
        var actionOptions = target.options[actionName];
        var actionOrigin = actionOptions && actionOptions.origin;
        var origin = actionOrigin || target.options.origin;
        var originRect = (0, _$rect_81.resolveRectLike)(origin, target, element, [target && element]);
        return (0, _$rect_81.rectToXY)(originRect) || {
            x: 0,
            y: 0
        };
    }
    var _$normalizeListeners_77 = {};
    "use strict";
    Object.defineProperty(_$normalizeListeners_77, "__esModule", {
        value: true
    });
    _$normalizeListeners_77["default"] = normalize;
    /* removed: var _$extend_71 = require("./extend.js"); */
    ;
    /* removed: var _$is_74 = require("./is.js"); */
    ;
    function normalize(type, listeners, result) {
        result = result || {};
        if (_$is_74["default"].string(type) && type.search(' ') !== -1) {
            type = split(type);
        }
        if (_$is_74["default"].array(type)) {
            return type.reduce(function (acc, t) {
                return (0, _$extend_71["default"])(acc, normalize(t, listeners, result));
            }, result);
        } // ({ type: fn }) -> ('', { type: fn })
        if (_$is_74["default"].object(type)) {
            listeners = type;
            type = '';
        }
        if (_$is_74["default"].func(listeners)) {
            result[type] = result[type] || [];
            result[type].push(listeners);
        }
        else if (_$is_74["default"].array(listeners)) {
        ...
        else if (_$is_74["default"].object(listeners)) {
    ...
    var _$hypot_73 = {};
    "use strict";
    Object.defineProperty(_$hypot_73, "__esModule", {
        value: true
    });
    _$hypot_73["default"] = void 0;
    var ___default_73 = function _default(x, y) {
        return Math.sqrt(x * x + y * y);
    };
    _$hypot_73["default"] = ___default_73;
    var _$pointerExtend_78 = {};
    "use strict";
    Object.defineProperty(_$pointerExtend_78, "__esModule", {
        value: true
    });
    _$pointerExtend_78["default"] = void 0;
    ...
    var ___default_78 = pointerExtend;
    _$pointerExtend_78["default"] = ___default_78;
    var _$pointerUtils_79 = {};
    "use strict";
    Object.defineProperty(_$pointerUtils_79, "__esModule", {
        value: true
    });
    _$pointerUtils_79.copyCoords = copyCoords;
    _$pointerUtils_79.setCoordDeltas = setCoordDeltas;
    _$pointerUtils_79.setCoordVelocity = setCoordVelocity;
    _$pointerUtils_79.setZeroCoords = setZeroCoords;
    _$pointerUtils_79.isNativePointer = isNativePointer;
    _$pointerUtils_79.getXY = getXY;
    _$pointerUtils_79.getPageXY = getPageXY;
    _$pointerUtils_79.getClientXY = getClientXY;
    _$pointerUtils_79.getPointerId = getPointerId;
    _$pointerUtils_79.setCoords = setCoords;
    _$pointerUtils_79.getTouchPair = getTouchPair;
    _$pointerUtils_79.pointerAverage = pointerAverage;
    _$pointerUtils_79.touchBBox = touchBBox;
    _$pointerUtils_79.touchDistance = touchDistance;
    _$pointerUtils_79.touchAngle = touchAngle;
    _$pointerUtils_79.getPointerType = getPointerType;
    _$pointerUtils_79.getEventTargets = getEventTargets;
    _$pointerUtils_79.newCoords = newCoords;
    _$pointerUtils_79.coordsToEvent = coordsToEvent;
    Object.defineProperty(_$pointerUtils_79, "pointerExtend", {
        enumerable: true,
        get: function get() {
            return _$pointerExtend_78["default"];
        }
    });
    /* removed: var _$browser_67 = require("./browser.js"); */
    ;
    ...
    /* removed: var _$domUtils_70 = require("./domUtils.js"); */
    ;
    /* removed: var _$hypot_73 = require("./hypot.js"); */
    ;
    /* removed: var _$is_74 = require("./is.js"); */
    ;
    /* removed: var _$pointerExtend_78 = require("./pointerExtend.js"); */
    ;
    ...
    function isNativePointer(pointer) {
        return pointer instanceof _$domObjects_69["default"].Event || pointer instanceof _$domObjects_69["default"].Touch;
    ...
    function getPointerId(pointer) {
        return _$is_74["default"].number(pointer.pointerId) ? pointer.pointerId : pointer.identifier;
    }
    ...
    function getTouchPair(event) {
        ...
        if (_$is_74["default"].array(event)) {
            touches[0] = event[0];
            touches[1] = event[1];
        } // an event
        else {
    ...
    function touchDistance(event, deltaSource) {
        ...
        return (0, _$hypot_73["default"])(dx, dy);
    }
    ...
    function getEventTargets(event) {
        var path = _$is_74["default"].func(event.composedPath) ? event.composedPath() : event.path;
        return [_$domUtils_70.getActualElement(path ? path[0] : event.target), _$domUtils_70.getActualElement(event.currentTarget)];
    }
    function newCoords() {
        return {
            page: {
    ...
    var DropEvent = /*#__PURE__*/ function (_BaseEvent) {
        _inheritsLoose(DropEvent, _BaseEvent);
        /**
         * Class of events fired on dropzones during drags with acceptable targets.
         */
        function DropEvent(dropState, dragEvent, type) {
            var _this;
            _this = _BaseEvent.call(this, dragEvent._interaction) || this;
            _this.target = void 0;
         ...
         */
        var _proto = DropEvent.prototype;
    ...
    /* removed: var _$domUtils_70 = require("../../utils/domUtils.js"); */
    ;
    /* removed: var _$extend_71 = require("../../utils/extend.js"); */
    ;
    /* removed: var _$getOriginXY_72 = require("../../utils/getOriginXY.js"); */
    ;
    /* removed: var _$is_74 = require("../../utils/is.js"); */
    ;
    /* removed: var _$normalizeListeners_77 = require("../../utils/normalizeListeners.js"); */
    ;
    /* removed: var _$pointerUtils_79 = require("../../utils/pointerUtils.js"); */
    ;
    ...
    function __install_3(scope) {
        var actions = scope.actions, interact = scope.interactStatic, Interactable = scope.Interactable, defaults = scope.defaults;
        ...
        interact.dynamicDrop = function (newValue) {
            if (_$is_74["default"].bool(newValue)) {
        ...
        (0, _$extend_71["default"])(actions.phaselessTypes, {
            dragenter: true,
            dragleave: true,
            dropactivate: true,
            dropdeactivate: true,
    ...
    function collectDrops(_ref, draggableElement) {
        ...
        for (var _i = 0; _i < interactables.list.length; _i++) {
            ...
            if (_$is_74["default"].element(accept) && accept !== draggableElement || _$is_74["default"].string(accept) && !_$domUtils_70.matchesSelector(draggableElement, accept) || _$is_74["default"].func(accept) && !accept({
                dropzone: dropzone,
                draggableElement: draggableElement
            })) {
                continue;
            } // query for new elements if necessary
            var dropElements = _$is_74["default"].string(dropzone.target) ? dropzone._context.querySelectorAll(dropzone.target) : _$is_74["default"].array(dropzone.target) ? dropzone.target : [dropzone.target];
    ...
    function fireActivationEvents(activeDrops, event) {
        ...
        for (var _i3 = 0; _i3 < activeDrops.slice().length; _i3++) {
            ...
            var _ref5 = _ref4, dropzone = _ref5.dropzone, element = _ref5.element;
    ...
    function getDrop(_ref7, dragEvent, pointerEvent) {
        var dropState = _ref7.dropState, draggable = _ref7.interactable, dragElement = _ref7.element;
        ...
        for (var _i5 = 0; _i5 < dropState.activeDrops.length; _i5++) {
            ...
            var _ref9 = _ref8, dropzone = _ref9.dropzone, dropzoneElement = _ref9.element, rect = _ref9.rect;
        ...
        var dropIndex = _$domUtils_70.indexOfDeepestElement(validDrops);
    ...
    function onEventCreated(_ref10, scope) {
        var interaction = _ref10.interaction, iEvent = _ref10.iEvent, event = _ref10.event;
    ...
    function dropzoneMethod(interactable, options) {
        if (_$is_74["default"].object(options)) {
            ...
            if (options.listeners) {
                var normalized = (0, _$normalizeListeners_77["default"])(options.listeners); // rename 'drop' to '' as it will be prefixed with 'drop'
                var corrected = Object.keys(normalized).reduce(function (acc, type) {
                    var correctedType = /^(enter|leave)/.test(type) ? "drag" + type : /^(activate|deactivate|move)/.test(type) ? "drop" + type : type;
            ...
            if (_$is_74["default"].func(options.ondrop)) {
                interactable.on('drop', options.ondrop);
            }
            if (_$is_74["default"].func(options.ondropactivate)) {
                interactable.on('dropactivate', options.ondropactivate);
            }
            if (_$is_74["default"].func(options.ondropdeactivate)) {
                interactable.on('dropdeactivate', options.ondropdeactivate);
            }
            if (_$is_74["default"].func(options.ondragenter)) {
                interactable.on('dragenter', options.ondragenter);
            }
            if (_$is_74["default"].func(options.ondragleave)) {
                interactable.on('dragleave', options.ondragleave);
            }
            if (_$is_74["default"].func(options.ondropmove)) {
                interactable.on('dropmove', options.ondropmove);
            }
            if (/^(pointer|center)$/.test(options.overlap)) {
                interactable.options.drop.overlap = options.overlap;
            }
            else if (_$is_74["default"].number(options.overlap)) {
    ...
    function dropCheckMethod(interactable, dragEvent, event, draggable, draggableElement, dropElement, rect) {
        ...
        if (dropOverlap === 'pointer') {
            var origin = (0, _$getOriginXY_72["default"])(draggable, draggableElement, 'drag');
            var page = _$pointerUtils_79.getPageXY(dragEvent);
            page.x += origin.x;
            page.y += origin.y;
        ...
        if (dragRect && _$is_74["default"].number(dropOverlap)) {
    ...
    var drop = {
        ...
        listeners: {
            ...
            'interactions:after-action-start': function interactionsAfterActionStart(_ref12, scope) {
                var interaction = _ref12.interaction, event = _ref12.event, dragEvent = _ref12.iEvent;
                if (interaction.prepared.name !== 'drag') {
                    return;
                }
            ...
            'interactions:after-action-move': function interactionsAfterActionMove(_ref13, scope) {
                var interaction = _ref13.interaction, dragEvent = _ref13.iEvent;
                if (interaction.prepared.name !== 'drag') {
                    return;
                }
            ...
            'interactions:action-end': function interactionsActionEnd(arg, scope) {
                ...
                var interaction = arg.interaction, dragEvent = arg.iEvent;
    ...
    function updateGestureProps(_ref) {
        var interaction = _ref.interaction, iEvent = _ref.iEvent, phase = _ref.phase;
        ...
        if (starting) {
            iEvent.distance = _$pointerUtils_79.touchDistance(pointers, deltaSource);
            iEvent.box = _$pointerUtils_79.touchBBox(pointers);
            iEvent.scale = 1;
            iEvent.ds = 0;
            iEvent.angle = _$pointerUtils_79.touchAngle(pointers, deltaSource);
            iEvent.da = 0;
        ...
        if (_$is_74["default"].number(iEvent.scale) && iEvent.scale !== Infinity && !isNaN(iEvent.scale)) {
    ...
    function __install_6(scope) {
        var actions = scope.actions, browser = scope.browser, Interactable = scope.Interactable, defaults = scope.defaults; // Less Precision with touch input
    ...
    function resizeChecker(arg) {
        var interaction = arg.interaction, interactable = arg.interactable, element = arg.element, rect = arg.rect, buttons = arg.buttons;
        if (!rect) {
            return undefined;
        }
        var page = (0, _$extend_71["default"])({}, interaction.coords.cur.page);
        ...
        if (_$is_74["default"].object(resizeOptions.edges)) {
            var resizeEdges = {
                left: false,
                right: false,
                top: false,
    ...
    function resizable(interactable, options, scope) {
        if (_$is_74["default"].object(options)) {
            ...
            if (_$is_74["default"].string(options.axis) && /^x$|^y$|^xy$/.test(options.axis)) {
                interactable.options.resize.axis = options.axis;
            }
            else if (options.axis === null) {
                interactable.options.resize.axis = scope.defaults.actions.resize.axis;
            }
            if (_$is_74["default"].bool(options.preserveAspectRatio)) {
                interactable.options.resize.preserveAspectRatio = options.preserveAspectRatio;
            }
            else if (_$is_74["default"].bool(options.square)) {
    ...
    function checkResizeEdge(name, value, page, element, interactableElement, rect, margin) {
        ...
        if (value === true) {
            ...
            var width = _$is_74["default"].number(rect.width) ? rect.width : rect.right - rect.left;
            var height = _$is_74["default"].number(rect.height) ? rect.height : rect.bottom - rect.top; // don't use margin greater than half the relevent dimension
        ...
        if (!_$is_74["default"].element(element)) {
            return false;
        }
    ...
    function start(_ref) {
        ...
        interaction._rects = {
            start: (0, _$extend_71["default"])({}, rect),
            corrected: (0, _$extend_71["default"])({}, rect),
            previous: (0, _$extend_71["default"])({}, rect),
            delta: {
                left: 0,
                right: 0,
                width: 0,
    ...
    function __move_6(_ref2) {
        ...
        var _interaction$_rects = interaction._rects, startRect = _interaction$_rects.start, corrected = _interaction$_rects.corrected, deltaRect = _interaction$_rects.delta, previous = _interaction$_rects.previous;
        (0, _$extend_71["default"])(previous, corrected);
        if (invertible) {
            // if invertible, copy the current rect
            (0, _$extend_71["default"])(corrected, current);
    ...
    function end(_ref3) {
        var iEvent = _ref3.iEvent, interaction = _ref3.interaction;
        if (interaction.prepared.name !== 'resize' || !interaction.prepared.edges) {
            return;
        }
        var resizeEvent = iEvent;
    ...
    function updateEventAxes(_ref4) {
        var iEvent = _ref4.iEvent, interaction = _ref4.interaction;
    ...
    var resize = {
        ...
        getCursor: function getCursor(_ref6) {
            var edges = _ref6.edges, axis = _ref6.axis, name = _ref6.name;
    ...
    var _$raf_80 = {};
    "use strict";
    Object.defineProperty(_$raf_80, "__esModule", {
        value: true
    });
    _$raf_80["default"] = void 0;
    var lastTime = 0;
    var _request;
    var _cancel;
    function __init_80(window) {
    ...
    _$raf_80["default"] = ___default_80;
    var _$plugin_8 = {};
    "use strict";
    ...
    /* removed: var _$is_74 = require("../utils/is.js"); */
    ;
    /* removed: var _$raf_80 = require("../utils/raf.js"); */
    ;
    /* removed: var _$rect_81 = require("../utils/rect.js"); */
    ;
    /* removed: var _$window_82 = require("../utils/window.js"); */
    ;
    function __install_8(scope) {
        var defaults = scope.defaults, actions = scope.actions;
    ...
    var autoScroll = {
        ...
        start: function start(interaction) {
            ...
            _$raf_80["default"].cancel(autoScroll.i);
            interaction.autoScroll = autoScroll;
            autoScroll.interaction = interaction;
            autoScroll.prevTime = autoScroll.now();
            autoScroll.i = _$raf_80["default"].request(autoScroll.scroll);
        },
        stop: function stop() {
        ...
        scroll: function scroll() {
            ...
            if (s >= 1) {
                ...
                if (scrollBy.x || scrollBy.y) {
                    ...
                    if (_$is_74["default"].window(container)) {
        ...
        onInteractionMove: function onInteractionMove(_ref) {
            var interaction = _ref.interaction, pointer = _ref.pointer;
            ...
            if (_$is_74["default"].window(container)) {
                ...
                var rect = _$domUtils_70.getElementClientRect(container);
    ...
    function getContainer(value, interactable, element) {
        return (_$is_74["default"].string(value) ? (0, _$rect_81.getStringOptionResult)(value, interactable, element) : value) || (0, _$window_82.getWindow)(element);
    }
    ...
    function getScrollSizeDelta(_ref2, func) {
        var interaction = _ref2.interaction, element = _ref2.element;
    ...
    var _$misc_76 = {};
    "use strict";
    Object.defineProperty(_$misc_76, "__esModule", {
        value: true
    });
    _$misc_76.warnOnce = warnOnce;
    _$misc_76.copyAction = copyAction;
    /* removed: var _$window_82 = require("./window.js"); */
    ;
    ...
    /* removed: var _$is_74 = require("../utils/is.js"); */
    ;
    /* removed: var _$misc_76 = require("../utils/misc.js"); */
    ;
    function __install_9(scope) {
         ...
         * Interactable
         */
        Interactable.prototype.ignoreFrom = (0, _$misc_76.warnOnce)(function (newValue) {
         ...
         * Interactable
         */
        Interactable.prototype.allowFrom = (0, _$misc_76.warnOnce)(function (newValue) {
    ...
    function actionChecker(checker) {
        if (_$is_74["default"].func(checker)) {
    ...
    function __install_10(scope) {
        var interact = scope.interactStatic, defaults = scope.defaults;
        scope.usePlugin(_$InteractableMethods_9["default"]);
        defaults.base.actionChecker = null;
        defaults.base.styleCursor = true;
        (0, _$extend_71["default"])(defaults.perAction, {
            manualStart: false,
            max: Infinity,
            maxPerElement: 1,
            allowFrom: null,
    ...
    function getActionInfo(interaction, pointer, event, eventTarget, scope) {
        ...
        while (_$is_74["default"].element(element)) {
            ...
            element = _$domUtils_70.parentNode(element);
        }
        return {
            action: null,
            interactable: null,
    ...
    function prepare(interaction, _ref4, scope) {
        ...
        (0, _$misc_76.copyAction)(interaction.prepared, action);
    ...
    function maxInteractions(newValue, scope) {
        if (_$is_74["default"].number(newValue)) {
    ...
    function setInteractionCursor(interaction, scope) {
        var interactable = interaction.interactable, element = interaction.element, prepared = interaction.prepared;
        ...
        if (prepared.name) {
            ...
            if (_$is_74["default"].func(cursorChecker)) {
    ...
    var hold = {
        ...
        listeners: {
            ...
            'interactions:move': function interactionsMove(_ref3) {
                var interaction = _ref3.interaction, duplicate = _ref3.duplicate;
    ...
    function checkAndPreventDefault(interactable, scope, event) {
        ...
        if (scope.events.supportsPassive && /^touch(start|move)$/.test(event.type)) {
            var doc = (0, _$window_82.getWindow)(event.target).document;
        ...
        if (_$is_74["default"].element(event.target) && (0, _$domUtils_70.matchesSelector)(event.target, 'input,select,textarea,[contenteditable=true],[contenteditable=true] *')) {
            return;
        }
        event.preventDefault();
    }
    ...
    /* removed: var _$domObjects_69 = require("../utils/domObjects.js"); */
    ;
    /* removed: var _$domUtils_70 = require("../utils/domUtils.js"); */
    ;
    /* removed: var _$extend_71 = require("../utils/extend.js"); */
    ...
    function __install_30(scope, _temp) {
        var _ref = _temp === void 0 ? {} : _temp, logger = _ref.logger;
        var Interactable = scope.Interactable, defaults = scope.defaults;
        ...
        Interactable.prototype.devTools = function (options) {
            if (options) {
                (0, _$extend_71["default"])(this.options.devTools, options);
                return this;
            }
    ...
    var checks = [{
            ...
            perform: function perform(interaction) {
                ...
                return interaction.prepared.name === 'resize' && element instanceof _$domObjects_69["default"].HTMLElement && !hasStyle(element, 'boxSizing', /border-box/);
            },
            ...
            perform: function perform(interaction) {
                var actionName = interaction.prepared.name;
                var moveListeners = interaction.interactable.events.types[actionName + "move"] || [];
    ...
    function hasStyle(element, prop, styleRe) {
        var value = element.style[prop] || _$window_82.window.getComputedStyle(element)[prop];
        return styleRe.test((value || '').toString());
    }
    function parentHasStyle(element, prop, styleRe) {
        var parent = element;
        while (_$is_74["default"].element(parent)) {
    ...
    function clone(source) {
        ...
        for (var prop in source) {
            ...
            if (_$is_74["default"].plainObject(value)) {
                dest[prop] = clone(value);
            }
            else if (_$is_74["default"].array(value)) {
    ...
    var Modification = /*#__PURE__*/ function () {
        ...
        var _proto = Modification.prototype;
        _proto.start = function start(_ref, pageCoords) {
            var phase = _ref.phase;
            var interaction = this.interaction;
            var modifierList = getModifierList(interaction);
            this.prepareStates(modifierList);
            this.edges = (0, _$extend_71["default"])({}, interaction.edges);
        ...
        _proto.fillArg = function fillArg(arg) {
            var interaction = this.interaction;
        ...
        _proto.setAll = function setAll(arg) {
            this.fillArg(arg);
            var phase = arg.phase, preEnd = arg.preEnd, skipModifiers = arg.skipModifiers, unmodifiedRect = arg.rect;
            arg.coords = (0, _$extend_71["default"])({}, arg.pageCoords);
            arg.rect = (0, _$extend_71["default"])({}, unmodifiedRect);
            ...
            for (var _i2 = 0; _i2 < states.length; _i2++) {
                ...
                if (state.methods.set && this.shouldDo(options, preEnd, phase)) {
                    ...
                    _$rect_81.addEdges(this.interaction.edges, arg.rect, {
        ...
        _proto.applyToInteraction = function applyToInteraction(arg) {
            var interaction = this.interaction;
            var phase = arg.phase;
            var curCoords = interaction.coords.cur;
            var startCoords = interaction.coords.start;
            var result = this.result, startDelta = this.startDelta;
            var curDelta = result.delta;
            if (phase === 'start') {
                (0, _$extend_71["default"])(this.startDelta, result.delta);
            }
            var _arr = [[startCoords, startDelta], [curCoords, curDelta]];
            for (var _i3 = 0; _i3 < _arr.length; _i3++) {
                var _arr$_i = _arr[_i3], coordsSet = _arr$_i[0], delta = _arr$_i[1];
        ...
        _proto.setAndApply = function setAndApply(arg) {
            var interaction = this.interaction;
            var phase = arg.phase, preEnd = arg.preEnd, skipModifiers = arg.skipModifiers;
        ...
        _proto.beforeEnd = function beforeEnd(arg) {
            var interaction = arg.interaction, event = arg.event;
        ...
        _proto.stop = function stop(arg) {
            var interaction = arg.interaction;
            if (!this.states || !this.states.length) {
                return;
            }
            var modifierArg = (0, _$extend_71["default"])({
                states: this.states,
        ...
        _proto.prepareStates = function prepareStates(modifierList) {
            this.states = [];
        ...
        _proto.restoreInteractionCoords = function restoreInteractionCoords(_ref6) {
            var _ref6$interaction = _ref6.interaction, coords = _ref6$interaction.coords, rect = _ref6$interaction.rect, modification = _ref6$interaction.modification;
            if (!modification.result) {
                return;
            }
            var startDelta = modification.startDelta;
            var _modification$result = modification.result, curDelta = _modification$result.delta, rectDelta = _modification$result.rectDelta;
            var coordsAndDeltas = [[coords.start, startDelta], [coords.cur, curDelta]];
            for (var _i6 = 0; _i6 < coordsAndDeltas.length; _i6++) {
                var _coordsAndDeltas$_i = coordsAndDeltas[_i6], coordsSet = _coordsAndDeltas$_i[0], delta = _coordsAndDeltas$_i[1];
                coordsSet.page.x -= delta.x;
                coordsSet.page.y -= delta.y;
                coordsSet.client.x -= delta.x;
                coordsSet.client.y -= delta.y;
        ...
        _proto.shouldDo = function shouldDo(options, preEnd, phase, requireEndOnly) {
        ...
        _proto.copyFrom = function copyFrom(other) {
            ...
            this.result = createResult((0, _$extend_71["default"])({}, other.result.coords), (0, _$extend_71["default"])({}, other.result.rect));
        };
    ...
    function addEventModifiers(_ref) {
        var iEvent = _ref.iEvent, result = _ref.interaction.modification.result;
        if (result) {
    ...
    /* removed: var _$getOriginXY_72 = require("../utils/getOriginXY.js"); */
    ;
    /* removed: var _$hypot_73 = require("../utils/hypot.js"); */
    ;
    ...
    function ___inheritsLoose_17(subClass, superClass) {
        subClass.prototype = Object.create(superClass.prototype);
        subClass.prototype.constructor = subClass;
        subClass.__proto__ = superClass;
    }
    var InteractEvent = /*#__PURE__*/ function (_BaseEvent) {
        ___inheritsLoose_17(InteractEvent, _BaseEvent); // resize
        /** */
        function InteractEvent(interaction, event, actionName, phase, element, preEnd, type) {
            var _this;
            _this = _BaseEvent.call(this, interaction) || this;
            _this.target = void 0;
            ...
            var origin = (0, _$getOriginXY_72["default"])(target, element, actionName);
            var starting = phase === 'start';
            var ending = phase === 'end';
            ...
            _this.page = (0, _$extend_71["default"])({}, coords.page);
            _this.client = (0, _$extend_71["default"])({}, coords.client);
            _this.rect = (0, _$extend_71["default"])({}, interaction.rect);
            ...
            _this.velocity = (0, _$extend_71["default"])({}, interaction.coords.velocity[deltaSource]);
            _this.speed = (0, _$hypot_73["default"])(_this.velocity.x, _this.velocity.y);
            _this.swipe = ending || phase === 'inertiastart' ? _this.getSwipe() : null;
            return _this;
        }
        var _proto = InteractEvent.prototype;
        _proto.getSwipe = function getSwipe() {
    ...
    var Interaction = /*#__PURE__*/ function () {
        ...
        function Interaction(_ref) {
            var _this = this;
            var pointerType = _ref.pointerType, scopeFire = _ref.scopeFire;
            ...
            this.doMove = (0, _$misc_76.warnOnce)(function (signalArg) {
                this.move(signalArg);
            }, 'The interaction.doMove() method has been renamed to interaction.move()');
            this.coords = {
                // Starting InteractEvent pointer coordinates
                start: _$pointerUtils_79.newCoords(),
                // Previous native pointer move event coordinates
                prev: _$pointerUtils_79.newCoords(),
                // current native pointer move event coordinates
                cur: _$pointerUtils_79.newCoords(),
                // Change in coordinates and time of the pointer
                delta: _$pointerUtils_79.newCoords(),
                // pointer velocity
                velocity: _$pointerUtils_79.newCoords()
            };
            this._id = idCounter++;
        ...
        _proto.pointerDown = function pointerDown(pointer, event, eventTarget) {
        ...
        _proto.start = function start(action, interactable, element) {
            ...
            (0, _$misc_76.copyAction)(this.prepared, action);
            this.interactable = interactable;
            this.element = element;
            this.rect = interactable.getRect(element);
            this.edges = this.prepared.edges ? (0, _$extend_71["default"])({}, this.prepared.edges) : {
                left: true,
                right: true,
                top: true,
                bottom: true
        ...
        _proto.pointerMove = function pointerMove(pointer, event, eventTarget) {
            ...
            if (this.pointerIsDown && !this.pointerWasMoved) {
                ...
                this.pointerWasMoved = (0, _$hypot_73["default"])(dx, dy) > this.pointerMoveTolerance;
            }
            ...
            if (!duplicateMove) {
                ...
                _$pointerUtils_79.setCoordVelocity(this.coords.velocity, this.coords.delta);
            }
            ...
            if (!duplicateMove && !this.simulation) {
                ...
                if (this.pointerWasMoved) {
                    _$pointerUtils_79.copyCoords(this.coords.prev, this.coords.cur);
                }
            }
        };
        _proto.move = function move(signalArg) {
            if (!signalArg || !signalArg.event) {
                _$pointerUtils_79.setZeroCoords(this.coords.delta);
            }
            signalArg = (0, _$extend_71["default"])({
        ...
        ;
        _proto.pointerUp = function pointerUp(pointer, event, eventTarget, curEventTarget) {
            var pointerIndex = this.getPointerIndex(pointer);
            if (pointerIndex === -1) {
        ...
        _proto.documentBlur = function documentBlur(event) {
            this.end(event);
        ...
        _proto.currentAction = function currentAction() {
            return this._interacting ? this.prepared.name : null;
        };
        _proto.interacting = function interacting() {
            return this._interacting;
        };
        ...
        _proto.getPointerIndex = function getPointerIndex(pointer) {
            var pointerId = _$pointerUtils_79.getPointerId(pointer); // mouse and pen interactions may have only one pointer
        ...
        _proto.getPointerInfo = function getPointerInfo(pointer) {
            return this.pointers[this.getPointerIndex(pointer)];
        };
        _proto.updatePointer = function updatePointer(pointer, event, eventTarget, down) {
            var id = _$pointerUtils_79.getPointerId(pointer);
            var pointerIndex = this.getPointerIndex(pointer);
            var pointerInfo = this.pointers[pointerIndex];
            ...
            _$pointerUtils_79.setCoords(this.coords.cur, this.pointers.map(function (p) {
                return p.pointer;
            }), this._now());
            _$pointerUtils_79.setCoordDeltas(this.coords.delta, this.coords.prev, this.coords.cur);
            if (down) {
                this.pointerIsDown = true;
                pointerInfo.downTime = this.coords.cur.timeStamp;
                pointerInfo.downTarget = eventTarget;
                _$pointerUtils_79.pointerExtend(this.downPointer, pointer);
                if (!this.interacting()) {
                    _$pointerUtils_79.copyCoords(this.coords.start, this.coords.cur);
                    _$pointerUtils_79.copyCoords(this.coords.prev, this.coords.cur);
        ...
        _proto._updateLatestPointer = function _updateLatestPointer(pointer, event, eventTarget) {
        ...
        _proto._createPreparedEvent = function _createPreparedEvent(event, phase, preEnd, type) {
            return new _$InteractEvent_17.InteractEvent(this, event, this.prepared.name, phase, this.element, preEnd, type);
        };
        _proto._fireEvent = function _fireEvent(iEvent) {
            this.interactable.fire(iEvent);
            if (!this.prevEvent || iEvent.timeStamp >= this.prevEvent.timeStamp) {
                this.prevEvent = iEvent;
            }
        };
        _proto._doPhase = function _doPhase(signalArg) {
            var event = signalArg.event, phase = signalArg.phase, preEnd = signalArg.preEnd, type = signalArg.type;
            var rect = this.rect;
            if (rect && phase === 'move') {
                // update the rect changes due to pointer move
                _$rect_81.addEdges(this.edges, rect, this.coords.delta[this.interactable.options.deltaSource]);
                rect.width = rect.right - rect.left;
                rect.height = rect.bottom - rect.top;
            }
            var beforeResult = this._scopeFire("interactions:before-action-" + phase, signalArg);
    ...
    function applyPending(interaction) {
        ...
        _$rect_81.addEdges(interaction.edges, interaction.rect, pending);
        pending.x = 0;
        pending.y = 0;
        return true;
    }
    ...
    function addToCoords(_ref5, _ref6) {
        var page = _ref5.page, client = _ref5.client;
    ...
    var InertiaState = /*#__PURE__*/ function () {
        ...
        var _proto = InertiaState.prototype;
        _proto.start = function start(event) {
            var interaction = this.interaction;
            ...
            var pointerSpeed = (0, _$hypot_73["default"])(velocityClient.x, velocityClient.y);
        ...
        _proto.startInertia = function startInertia() {
            var _this = this;
            ...
            var modification = this.modification, modifierArg = this.modifierArg;
        ...
        _proto.startSmoothEnd = function startSmoothEnd() {
            var _this2 = this;
            this.smoothEnd = true;
            this.isModified = true;
            this.targetOffset = {
        ...
        _proto.onNextFrame = function onNextFrame(tickFn) {
            var _this3 = this;
            this.timeout = _$raf_80["default"].request(function () {
                if (_this3.active) {
                    tickFn();
                }
            });
        };
        _proto.inertiaTick = function inertiaTick() {
            var _this4 = this;
            var interaction = this.interaction;
            var options = getOptions(interaction);
            var lambda = options.resistance;
        ...
        _proto.smoothEndTick = function smoothEndTick() {
            var _this5 = this;
            var interaction = this.interaction;
            var t = interaction._now() - this.t0;
            var _getOptions = getOptions(interaction), duration = _getOptions.smoothEndDuration;
            if (t < duration) {
                var newOffset = {
        ...
        _proto.resume = function resume(_ref) {
            ...
            (0, _$pointerUtils_79.copyCoords)(interaction.coords.prev, interaction.coords.cur);
            this.stop();
        };
        ...
        _proto.stop = function stop() {
            ...
            _$raf_80["default"].cancel(this.timeout);
        };
        return InertiaState;
    }();
    _$plugin_32.InertiaState = InertiaState;
    function __start_32(_ref2) {
        var interaction = _ref2.interaction, event = _ref2.event;
    ...
    function resume(arg) {
        var interaction = arg.interaction, eventTarget = arg.eventTarget;
    ...
    function getOptions(_ref4) {
        var interactable = _ref4.interactable, prepared = _ref4.prepared;
    ...
    var Eventable = /*#__PURE__*/ function () {
        function Eventable(options) {
            ...
            this.immediatePropagationStopped = false;
            this.global = void 0;
            this.options = (0, _$extend_71["default"])({}, options || {});
        }
        var _proto = Eventable.prototype;
        ...
        _proto.on = function on(type, listener) {
            var listeners = (0, _$normalizeListeners_77["default"])(type, listener);
        ...
        _proto.getRect = function getRect(_element) {
            return null;
        };
        return Eventable;
    }();
    ...
    function ___createClass_18(Constructor, protoProps, staticProps) {
        if (protoProps)
            ___defineProperties_18(Constructor.prototype, protoProps);
        if (staticProps)
            ___defineProperties_18(Constructor, staticProps);
        return Constructor;
    }
    /** */
    var Interactable = /*#__PURE__*/ function () {
        ...
        function Interactable(target, options, defaultContext, scopeEvents) {
            ...
            this._win = (0, _$window_82.getWindow)((0, _$domUtils_70.trySelector)(target) ? this._context : target);
            this._doc = this._win.document;
            this._scopeEvents = scopeEvents;
            this.set(options);
        }
        var _proto = Interactable.prototype;
        _proto.setOnEvents = function setOnEvents(actionName, phases) {
            if (_$is_74["default"].func(phases.onstart)) {
                this.on(actionName + "start", phases.onstart);
            }
            if (_$is_74["default"].func(phases.onmove)) {
                this.on(actionName + "move", phases.onmove);
            }
            if (_$is_74["default"].func(phases.onend)) {
                this.on(actionName + "end", phases.onend);
            }
            if (_$is_74["default"].func(phases.oninertiastart)) {
                this.on(actionName + "inertiastart", phases.oninertiastart);
            }
            return this;
        };
        _proto.updatePerActionListeners = function updatePerActionListeners(actionName, prev, cur) {
            if (_$is_74["default"].array(prev) || _$is_74["default"].object(prev)) {
                this.off(actionName, prev);
            }
            if (_$is_74["default"].array(cur) || _$is_74["default"].object(cur)) {
                this.on(actionName, cur);
            }
        };
        _proto.setPerAction = function setPerAction(actionName, options) {
        ...
        _proto.getRect = function getRect(element) {
            element = element || (_$is_74["default"].element(this.target) ? this.target : null);
            if (_$is_74["default"].string(this.target)) {
                element = element || this._context.querySelector(this.target);
            }
            return (0, _$domUtils_70.getElementRect)(element);
        };
        _proto.rectChecker = function rectChecker(checker) {
            var _this = this;
            if (_$is_74["default"].func(checker)) {
                this._rectChecker = checker;
                this.getRect = function (element) {
                    var rect = (0, _$extend_71["default"])({}, _this._rectChecker(element));
                    if (!('width' in rect)) {
                        rect.width = rect.right - rect.left;
                        rect.height = rect.bottom - rect.top;
                    }
        ...
        _proto.origin = function origin(newValue) {
            return this._backCompatOption('origin', newValue);
        };
        _proto.deltaSource = function deltaSource(newValue) {
        ...
        _proto.inContext = function inContext(element) {
            return this._context === element.ownerDocument || (0, _$domUtils_70.nodeContains)(this._context, element);
        };
        _proto.testIgnoreAllow = function testIgnoreAllow(options, targetNode, eventTarget) {
            return !this.testIgnore(options.ignoreFrom, targetNode, eventTarget) && this.testAllow(options.allowFrom, targetNode, eventTarget);
        };
        _proto.testAllow = function testAllow(allowFrom, targetNode, element) {
            if (!allowFrom) {
                return true;
            }
            if (!_$is_74["default"].element(element)) {
            ...
            if (_$is_74["default"].string(allowFrom)) {
                return (0, _$domUtils_70.matchesUpTo)(element, allowFrom, targetNode);
            }
            else if (_$is_74["default"].element(allowFrom)) {
                return (0, _$domUtils_70.nodeContains)(allowFrom, element);
            }
            return false;
        };
        _proto.testIgnore = function testIgnore(ignoreFrom, targetNode, element) {
            if (!ignoreFrom || !_$is_74["default"].element(element)) {
                return false;
            }
            if (_$is_74["default"].string(ignoreFrom)) {
                return (0, _$domUtils_70.matchesUpTo)(element, ignoreFrom, targetNode);
            }
            else if (_$is_74["default"].element(ignoreFrom)) {
                return (0, _$domUtils_70.nodeContains)(ignoreFrom, element);
            }
            return false;
        };
        _proto.fire = function fire(iEvent) {
            this.events.fire(iEvent);
            return this;
        };
        _proto._onOff = function _onOff(method, typeArg, listenerArg, options) {
            if (_$is_74["default"].object(typeArg) && !_$is_74["default"].array(typeArg)) {
                options = listenerArg;
                listenerArg = null;
            }
            var addRemove = method === 'on' ? 'add' : 'remove';
            var listeners = (0, _$normalizeListeners_77["default"])(typeArg, listenerArg);
            for (var type in listeners) {
                ...
                for (var _i = 0; _i < listeners[type].length; _i++) {
                    ...
                    else if (_$is_74["default"].string(this.target)) {
        ...
        _proto.on = function on(types, listener, options) {
            return this._onOff('on', types, listener, options);
        };
        _proto.off = function off(types, listener, options) {
        ...
        _proto.set = function set(options) {
            ...
            for (var actionName_ in this._actions.methodDict) {
                ...
                this.setPerAction(actionName, (0, _$extend_71["default"])((0, _$extend_71["default"])({}, defaults.perAction), defaults.actions[actionName]));
            ...
            if (_$is_74["default"].string(this.target)) {
                ...
                for (var type in this._scopeEvents.delegatedEvents) {
                    ...
                    for (var i = delegated.length - 1; i >= 0; i--) {
                        var _delegated$i = delegated[i], selector = _delegated$i.selector, context = _delegated$i.context, listeners = _delegated$i.listeners;
    ...
    var InteractableSet = /*#__PURE__*/ function () {
        ...
        function InteractableSet(scope) {
            ...
            scope.addListeners({
                'interactable:unset': function interactableUnset(_ref) {
                    ...
                    var targetMappings = _$is_74["default"].string(target) ? _this.selectorMap[target] : target[_this.scope.id];
        ...
        var _proto = InteractableSet.prototype;
        _proto["new"] = function _new(target, options) {
            options = (0, _$extend_71["default"])(options || {}, {
            ...
            if (_$is_74["default"].string(target)) {
        ...
        _proto.get = function get(target, options) {
            var context = options && options.context || this.scope.document;
            var isSelector = _$is_74["default"].string(target);
        ...
        _proto.forEachMatch = function forEachMatch(node, callback) {
    ...
    /* removed: var _$is_74 = require("../utils/is.js"); */
    ;
    /* removed: var _$pointerExtend_78 = require("../utils/pointerExtend.js"); */
    ;
    /* removed: var _$pointerUtils_79 = require("../utils/pointerUtils.js"); */
    ;
    function __install_23(scope) {
            ...
            for (index = delegates.length - 1; index >= 0; index--) {
                ...
                if (cur.selector === selector && cur.context === context) {
                    ...
                    for (var i = listeners.length - 1; i >= 0; i--) {
                        var _listeners$i = listeners[i], fn = _listeners$i[0], _listeners$i$ = _listeners$i[1], capture = _listeners$i$.capture, passive = _listeners$i$.passive; // check if the listener functions and capture and passive flags match
        ...
        function delegateListener(event, optionalArg) {
            ...
            var _pointerUtils$getEven = _$pointerUtils_79.getEventTargets(event), eventTarget = _pointerUtils$getEven[0];
            var element = eventTarget; // climb up document tree looking for selector matches
            while (_$is_74["default"].element(element)) {
                for (var i = 0; i < delegates.length; i++) {
                    var cur = delegates[i];
                    var selector = cur.selector, context = cur.context;
                    if (_$domUtils_70.matchesSelector(element, selector) && _$domUtils_70.nodeContains(context, eventTarget) && _$domUtils_70.nodeContains(context, element)) {
                        var listeners = cur.listeners;
                        fakeEvent.currentTarget = element;
                        for (var _i3 = 0; _i3 < listeners.length; _i3++) {
                            var _ref2;
                            _ref2 = listeners[_i3];
                            var _ref3 = _ref2, fn = _ref3[0], _ref3$ = _ref3[1], capture = _ref3$.capture, passive = _ref3$.passive;
    ...
    var FakeEvent = /*#__PURE__*/ function () {
        function FakeEvent(originalEvent) {
            ...
            (0, _$pointerExtend_78["default"])(this, originalEvent);
        }
        var _proto = FakeEvent.prototype;
        _proto.preventOriginalDefault = function preventOriginalDefault() {
    ...
    function __getOptions_23(param) {
        if (!_$is_74["default"].object(param)) {
            return {
                capture: !!param,
                passive: false
            };
        }
        var options = (0, _$extend_71["default"])({}, param);
    ...
    function createInteractStatic(scope) {
        ...
        interact.getPointerAverage = _$pointerUtils_79.pointerAverage;
        interact.getTouchBBox = _$pointerUtils_79.touchBBox;
        interact.getTouchDistance = _$pointerUtils_79.touchDistance;
        interact.getTouchAngle = _$pointerUtils_79.touchAngle;
        interact.getElementRect = _$domUtils_70.getElementRect;
        interact.getElementClientRect = _$domUtils_70.getElementClientRect;
        interact.matchesSelector = _$domUtils_70.matchesSelector;
        ...
        *
         ...
         */
        interact.on = (0, _$misc_76.warnOnce)(function on(type, listener, options) {
            if (_$is_74["default"].string(type) && type.search(' ') !== -1) {
         ...
         * @return {object} interact
         */
        interact.off = (0, _$misc_76.warnOnce)(function off(type, listener, options) {
            if (_$is_74["default"].string(type) && type.search(' ') !== -1) {
                type = type.trim().split(/ +/);
            }
            if (_$is_74["default"].array(type)) {
    ...
    function ___createClass_27(Constructor, protoProps, staticProps) {
        if (protoProps)
            ___defineProperties_27(Constructor.prototype, protoProps);
        if (staticProps)
            ___defineProperties_27(Constructor, staticProps);
        return Constructor;
    }
    function ___inheritsLoose_27(subClass, superClass) {
        subClass.prototype = Object.create(superClass.prototype);
        subClass.prototype.constructor = subClass;
        subClass.__proto__ = superClass;
    }
    ...
    function __install_27(scope) {
        ...
        var docEvents;
        if (_$domObjects_69["default"].PointerEvent) {
            docEvents = [{
        ...
        scope.Interaction = /*#__PURE__*/ function (_InteractionBase) {
            ___inheritsLoose_27(_class, _InteractionBase);
            function _class() {
                return _InteractionBase.apply(this, arguments) || this;
            }
    ...
    function doOnInteractions(method, scope) {
        return function (event) {
            ...
            var pointerType = _$pointerUtils_79.getPointerType(event);
            var _pointerUtils$getEven = _$pointerUtils_79.getEventTargets(event), eventTarget = _pointerUtils$getEven[0], curEventTarget = _pointerUtils$getEven[1];
            ...
            if (/^touch/.test(event.type)) {
                ...
                for (var _i5 = 0; _i5 < event.changedTouches.length; _i5++) {
                    ...
                    var pointerId = _$pointerUtils_79.getPointerId(pointer);
                    var searchDetails = {
                        pointer: pointer,
                        pointerId: pointerId,
                ...
                if (!invalidPointer) {
                    var _searchDetails = {
                        pointer: event,
                        pointerId: _$pointerUtils_79.getPointerId(event),
                        pointerType: pointerType,
                        eventType: event.type,
                        curEventTarget: curEventTarget,
                        eventTarget: eventTarget,
            ...
            for (var _i6 = 0; _i6 < matches.length; _i6++) {
                var _matches$_i = matches[_i6], _pointer = _matches$_i[0], _eventTarget = _matches$_i[1], _curEventTarget = _matches$_i[2], _interaction2 = _matches$_i[3];
    ...
    function onDocSignal(_ref7, eventMethodName) {
        var doc = _ref7.doc, scope = _ref7.scope, options = _ref7.options;
        var docEvents = scope.interactions.docEvents, events = scope.events;
    ...
    function ___createClass_29(Constructor, protoProps, staticProps) {
        if (protoProps)
            ___defineProperties_29(Constructor.prototype, protoProps);
        if (staticProps)
            ___defineProperties_29(Constructor, staticProps);
        return Constructor;
    }
    function ___inheritsLoose_29(subClass, superClass) {
        subClass.prototype = Object.create(superClass.prototype);
        subClass.prototype.constructor = subClass;
        subClass.__proto__ = superClass;
    }
    var Scope = /*#__PURE__*/ function () {
        ...
        function Scope() {
            ...
            this.Interactable = /*#__PURE__*/ function (_InteractableBase) {
                ___inheritsLoose_29(_class, _InteractableBase);
                function _class() {
                    return _InteractableBase.apply(this, arguments) || this;
                }
                var _proto2 = _class.prototype;
                _proto2.set = function set(options) {
        ...
        _proto.addListeners = function addListeners(map, id) {
            this.listenerMaps.push({
                id: id,
                map: map
            });
        };
        _proto.fire = function fire(name, arg) {
            for (var _i = 0; _i < this.listenerMaps.length; _i++) {
                var _ref;
                _ref = this.listenerMaps[_i];
                var _ref2 = _ref, listener = _ref2.map[name];
                if (!!listener && listener(arg, this, name) === false) {
                    return false;
                }
            }
        };
        _proto.init = function init(window) {
            return this.isInitialized ? this : initScope(this, window);
        };
        _proto.pluginIsInstalled = function pluginIsInstalled(plugin) {
            return this._plugins.map[plugin.id] || this._plugins.list.indexOf(plugin) !== -1;
        };
        _proto.usePlugin = function usePlugin(plugin, options) {
        ...
        _proto.addDocument = function addDocument(doc, options) {
            // do nothing if document is already known
            if (this.getDocIndex(doc) !== -1) {
                return false;
            }
            var window = _$window_82.getWindow(doc);
            options = options ? (0, _$extend_71["default"])({}, options) : {};
            this.documents.push({
                doc: doc,
                options: options
            });
        ...
        _proto.getDocIndex = function getDocIndex(doc) {
        ...
        _proto.getDocOptions = function getDocOptions(doc) {
    ...
    function initScope(scope, window) {
        ...
        _$window_82.init(window);
        _$domObjects_69["default"].init(window);
        _$browser_67["default"].init(window);
        _$raf_80["default"].init(window);
        scope.window = window;
    ...
    var ___default_64 = function _default(grid) {
        var coordFields = [['x', 'y'], ['left', 'top'], ['right', 'bottom'], ['width', 'height']].filter(function (_ref) {
            var xField = _ref[0], yField = _ref[1];
        ...
        var gridFunc = function gridFunc(x, y) {
            ...
            for (var _i = 0; _i < coordFields.length; _i++) {
                var _ref2;
                _ref2 = coordFields[_i];
                var _ref3 = _ref2, xField = _ref3[0], yField = _ref3[1];
    ...
    var snappersPlugin = {
        ...
        install: function install(scope) {
            var interact = scope.interactStatic;
            interact.snappers = (0, _$extend_71["default"])(interact.snappers || {}, _$all_61);
    ...
    var aspectRatio = {
        start: function start(arg) {
            var state = arg.state, rect = arg.rect, originalEdges = arg.edges, coords = arg.pageCoords;
            var ratio = state.options.ratio;
            var _state$options = state.options, equalDelta = _state$options.equalDelta, modifiers = _state$options.modifiers;
            if (ratio === 'preserve') {
                ratio = rect.width / rect.height;
            }
            state.startCoords = (0, _$extend_71["default"])({}, coords);
            state.startRect = (0, _$extend_71["default"])({}, rect);
            state.ratio = ratio;
            ...
            subModification.startAll(_extends({}, arg));
        },
        set: function set(arg) {
            var state = arg.state, rect = arg.rect, coords = arg.coords;
            var initialCoords = (0, _$extend_71["default"])({}, coords);
            var aspectMethod = state.equalDelta ? setEqualDelta : setRatio;
            aspectMethod(state, state.xIsPrimaryAxis, coords, rect);
            if (!state.subModification) {
                return null;
            }
            var correctedRect = (0, _$extend_71["default"])({}, rect);
            (0, _$rect_81.addEdges)(state.linkedEdges, correctedRect, {
                x: coords.x - initialCoords.x,
                y: coords.y - initialCoords.y
            });
            var result = state.subModification.setAll(_extends({}, arg, {
                rect: correctedRect,
            ...
            if (result.changed) {
                ...
                (0, _$extend_71["default"])(coords, result.coords);
            }
    ...
    function setEqualDelta(_ref, xIsPrimaryAxis, coords) {
        var startCoords = _ref.startCoords, edgeSign = _ref.edgeSign;
        if (xIsPrimaryAxis) {
    ...
    function setRatio(_ref2, xIsPrimaryAxis, coords, rect) {
        var startRect = _ref2.startRect, startCoords = _ref2.startCoords, ratio = _ref2.ratio, edgeSign = _ref2.edgeSign;
        if (xIsPrimaryAxis) {
    ...
    function __start_43(_ref) {
        var rect = _ref.rect, startOffset = _ref.startOffset, state = _ref.state, interaction = _ref.interaction, pageCoords = _ref.pageCoords;
        var options = state.options;
        var elementRect = options.elementRect;
        var offset = (0, _$extend_71["default"])({
            left: 0,
            top: 0,
            right: 0,
            bottom: 0
    ...
    function getRestrictionRect(value, interaction, coords) {
        if (_$is_74["default"].func(value)) {
            return _$rect_81.resolveRectLike(value, interaction.interactable, interaction.element, [coords.x, coords.y, interaction]);
        }
        else {
            return _$rect_81.resolveRectLike(value, interaction.interactable, interaction.element);
        }
    }
    var __defaults_43 = {
        restriction: null,
    ...
    function __start_42(_ref) {
        var interaction = _ref.interaction, startOffset = _ref.startOffset, state = _ref.state;
        var options = state.options;
        var offset;
        if (options) {
            var offsetRect = (0, _$pointer_43.getRestrictionRect)(options.offset, interaction, interaction.coords.start.page);
            offset = _$rect_81.rectToXY(offsetRect);
        }
        offset = offset || {
            x: 0,
            y: 0
    ...
    function __set_42(_ref2) {
        var coords = _ref2.coords, edges = _ref2.edges, interaction = _ref2.interaction, state = _ref2.state;
        var offset = state.offset, options = state.options;
        if (!edges) {
            return;
        }
        var page = (0, _$extend_71["default"])({}, coords);
    ...
    /* removed: var _$pointer_43 = require("./pointer.js"); */
    ;
    var __defaults_44 = (0, _$extend_71["default"])({
        get elementRect() {
            return {
                top: 0,
                left: 0,
    ...
    function __set_45(arg) {
        var interaction = arg.interaction, state = arg.state, rect = arg.rect, edges = arg.edges;
        var options = state.options;
        if (!edges) {
            return;
        }
        var minSize = _$rect_81.tlbrToXywh((0, _$pointer_43.getRestrictionRect)(options.min, interaction, arg.coords)) || noMin;
        var maxSize = _$rect_81.tlbrToXywh((0, _$pointer_43.getRestrictionRect)(options.max, interaction, arg.coords)) || noMax;
        state.options = {
            endOnly: options.endOnly,
            inner: (0, _$extend_71["default"])({}, _$edges_42.restrictEdges.noInner),
            outer: (0, _$extend_71["default"])({}, _$edges_42.restrictEdges.noOuter)
        };
        if (edges.top) {
    ...
    function __start_48(arg) {
        ...
        if (options.offset === 'startCoords') {
            ...
            var offsetRect = (0, _$rect_81.resolveRectLike)(options.offset, interactable, element, [interaction]);
            snapOffset = (0, _$rect_81.rectToXY)(offsetRect) || {
                x: 0,
                y: 0
            };
    ...
    function __set_48(arg) {
        ...
        var origin = (0, _$getOriginXY_72["default"])(interaction.interactable, interaction.element, interaction.prepared.name);
        var page = (0, _$extend_71["default"])({}, coords);
        var targets = [];
        ...
        for (var _i = 0; _i < offsets.length; _i++) {
            ...
            for (var index = 0, len = options.targets.length; index < len; index++) {
                ...
                var target = void 0;
                if (_$is_74["default"].func(snapTarget)) {
                ...
                targets.push({
                    x: (_$is_74["default"].number(target.x) ? target.x : relativeX) + offset.x,
                    y: (_$is_74["default"].number(target.y) ? target.y : relativeY) + offset.y,
                    range: _$is_74["default"].number(target.range) ? target.range : options.range,
                    source: snapTarget,
                    index: index,
                    offset: offset
                });
        ...
        for (var _i2 = 0; _i2 < targets.length; _i2++) {
            ...
            var distance = (0, _$hypot_73["default"])(dx, dy);
    ...
    function getOrigin(arg) {
        ...
        var optionsOrigin = (0, _$rect_81.rectToXY)((0, _$rect_81.resolveRectLike)(arg.state.options.origin, null, null, [element]));
        var origin = optionsOrigin || (0, _$getOriginXY_72["default"])(arg.interactable, element, arg.interaction.prepared.name);
        return origin;
    }
    var __defaults_48 = {
        range: Infinity,
    ...
    function __start_49(arg) {
        var state = arg.state, edges = arg.edges;
        var options = state.options;
        if (!edges) {
            return null;
        }
    ...
    function __set_49(arg) {
        ...
        state.options = (0, _$extend_71["default"])({}, options);
    ...
    var snapEdges = {
        ...
        defaults: (0, _$extend_71["default"])((0, _$clone_68["default"])(_$size_49.snapSize.defaults), {
            targets: null,
            range: null,
            offset: {
                x: 0,
    ...
    var __modifiers_41 = {
        ...
        install: function install(scope) {
            ...
            for (var type in _$all_36["default"]) {
                var _all$type = _$all_36["default"][type], _defaults = _all$type._defaults, _methods = _all$type._methods;
    ...
    function ___inheritsLoose_54(subClass, superClass) {
        subClass.prototype = Object.create(superClass.prototype);
        subClass.prototype.constructor = subClass;
        subClass.__proto__ = superClass;
    }
    var PointerEvent = /*#__PURE__*/ function (_BaseEvent) {
        ___inheritsLoose_54(PointerEvent, _BaseEvent);
        /** */
        function PointerEvent(type, pointer, event, eventTarget, interaction, timeStamp) {
            ...
            _$pointerUtils_79.pointerExtend(___assertThisInitialized_54(_this), event);
            if (event !== pointer) {
                _$pointerUtils_79.pointerExtend(___assertThisInitialized_54(_this), pointer);
            }
            _this.timeStamp = timeStamp;
            _this.originalEvent = event;
            _this.type = type;
            _this.pointerId = _$pointerUtils_79.getPointerId(pointer);
            _this.pointerType = _$pointerUtils_79.getPointerType(pointer);
        ...
        var _proto = PointerEvent.prototype;
        _proto._subtractOrigin = function _subtractOrigin(_ref) {
        ...
        _proto._addOrigin = function _addOrigin(_ref2) {
    ...
    function fire(arg, scope) {
        var interaction = arg.interaction, pointer = arg.pointer, event = arg.event, eventTarget = arg.eventTarget, type = arg.type, _arg$targets = arg.targets, targets = _arg$targets === void 0 ? collectEventTargets(arg, scope) : _arg$targets;
        ...
        for (var i = 0; i < targets.length; i++) {
            ...
            var origin = (0, _$getOriginXY_72["default"])(target.eventable, target.node);
    ...
    function collectEventTargets(_ref, scope) {
        ...
        var path = _$domUtils_70.getPath(eventTarget);
        var signalArg = {
            interaction: interaction,
            pointer: pointer,
            event: event,
    ...
    function clearHold(_ref5) {
        var interaction = _ref5.interaction, pointerIndex = _ref5.pointerIndex;
    ...
    function moveAndClearHold(arg, scope) {
        var interaction = arg.interaction, pointer = arg.pointer, event = arg.event, eventTarget = arg.eventTarget, duplicate = arg.duplicate;
    ...
    function __install_55(scope) {
        ...
        (0, _$extend_71["default"])(scope.actions.phaselessTypes, pointerEvents.types);
    }
    ...
    function pointerEventsMethod(options) {
        (0, _$extend_71["default"])(this.events.options, options);
        return this;
    }
    var plugin = {
        ...
        listeners: {
            ...
            'interactable:set': function interactableSet(_ref3, scope) {
                ...
                (0, _$extend_71["default"])(interactable.events.options, scope.pointerEvents.defaults);
                (0, _$extend_71["default"])(interactable.events.options, options.pointerEvents || {});
            }
        }
    };
    ...
    function doReflow(interactable, action, scope) {
        var elements = _$is_74["default"].string(interactable.target) ? _$arr_66.from(interactable._context.querySelectorAll(interactable.target)) : [interactable.target]; // tslint:disable-next-line variable-name
        ...
        var _loop = function _loop() {
            ...
            if (runningInteraction) {
                ...
                var xywh = (0, _$rect_81.tlbrToXywh)(rect);
                var coords = {
                    page: {
                        x: xywh.x,
                        y: xywh.y
                ...
                var event = _$pointerUtils_79.coordsToEvent(coords);
    ...
    function startReflow(scope, interactable, element, action, event) {
        ...
        _$pointerUtils_79.setZeroCoords(interaction.coords.delta);
        (0, _$misc_76.copyAction)(interaction.prepared, action);
    ...
    var ___default_60 = reflow;
    _$plugin_60["default"] = ___default_60;
    var _$plugin_83 = {};
    "use strict";
    Object.defineProperty(_$plugin_83, "__esModule", {
        value: true
    });
    _$plugin_83["default"] = void 0;
    var ___default_83 = {};
    _$plugin_83["default"] = ___default_83;
    var _$interactjs_34 = {
        exports: {}
    };
    "use strict";
    ...
    ;
    /* removed: var _$plugin_83 = require("../vue/plugin.js"); */
    ;
    ...
    _$interact_33["default"].use(_$plugin_83["default"]);
    _$interact_33["default"].use(_$plugin_59["default"]); // eslint-disable-next-line no-undef
    ...
    if ("object" === 'object' && !!_$interactjs_34) {
        try {
    ...
    "use strict";
    Object.defineProperty(_$index_84.exports, "__esModule", {
        value: true
    });
    _$index_84.exports["default"] = void 0;
    /* removed: var _$interactjs_34 = require("@interactjs/interactjs/index"); */
    ; // eslint-disable-next-line import/no-extraneous-dependencies
    var ___default_84 = _$interactjs_34["default"];
    _$index_84.exports["default"] = ___default_84;
    if ("object" === 'object' && !!_$index_84) {
        try {
            _$index_84.exports = _$interactjs_34["default"];
        }
        catch (_unused) { }
    }
